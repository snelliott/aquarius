...
//    this->addProduct(Product("ccsdtq-1b.T(3)", "T(3)", reqs));
    this->addProduct(Product("ccsdtq-1b.T4", "T4", reqs));
...
template <typename U>
void CCSDTQ_1b<U>::subiterate(const Arena& arena)
{
    const auto& H = this->template get<TwoElectronOperator<U>>("H");
...
template <typename U>
void CCSDTQ_1b<U>::microiterate(const Arena& arena)
{
    const auto& H = this->template get<TwoElectronOperator<U>>("H");
